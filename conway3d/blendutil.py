...
def set_active_layer_collection(name: str):
    ...
    found matching ``name`` sill be set active. No action is taken if no
    matching layer collection was found.
    ...
    """
    layer_collection = get_child_by_name(C.view_layer.layer_collection, name)
